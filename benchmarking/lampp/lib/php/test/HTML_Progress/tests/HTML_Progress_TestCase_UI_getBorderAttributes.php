 ...
 *
 * @version    $Id: HTML_Progress_TestCase_UI_getBorderAttributes.php,v 1.4 2005/08/28 14:12:09 farell Exp $
...
class HTML_Progress_TestCase_UI_getBorderAttributes extends PHPUnit_TestCase
{
    ...
    function HTML_Progress_TestCase_UI_getBorderAttributes($name)
    {
