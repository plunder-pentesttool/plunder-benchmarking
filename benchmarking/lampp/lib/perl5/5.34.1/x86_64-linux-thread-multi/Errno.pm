...
"x86_64-linux-thread-multi-5.15.49-linuxkit" or
	die "Errno architecture (x86_64-linux-thread-multi-5.15.49-linuxkit) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
