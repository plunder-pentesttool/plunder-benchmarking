...
#define PR_BUILD_OPTS " '--prefix=/opt/lampp' '--with-modules=mod_sql:mod_sql_mysql:mod_tls' '--with-includes=/opt/lampp/include:/opt/lampp/include/ncurses' '--with-libraries=/opt/lampp/lib/' 'CC=gcc' 'CFLAGS=-I/opt/lampp/include/c-client -I/opt/lampp/include/freetype2 -O3 -L/opt/lampp/lib -I/opt/lampp/include -I/opt/lampp/include/ncurses' 'LDFLAGS=-Wl,--rpath -Wl,/opt/lampp/lib -L/opt/lampp/lib -I/opt/lampp/include -L/opt/lampp/lib -L/opt/lampp' 'CPPFLAGS=-I/opt/lampp/include/c-client -I/opt/lampp/include/freetype2 -O3 -L/opt/lampp/lib -I/opt/lampp/include -I/opt/lampp/include/ncurses' 'CXX=g++' 'CXXFLAGS=-I/opt/lampp/include/c-client -I/opt/lampp/include/freetype2 -I/opt/lampp/include/ncurses -O3 -L/opt/lampp/lib -I/opt/lampp/include'"

/* Define to be the build CFLAGS.  */
#define PR_BUILD_CFLAGS "-g2 -I/opt/lampp/include/c-client -I/opt/lampp/include/freetype2 -O3 -L/opt/lampp/lib -I/opt/lampp/include -I/opt/lampp/include/ncurses -Wall -fno-omit-frame-pointer"

/* Define to be the build LDLAGS.  */
#define PR_BUILD_LDFLAGS "-L$(top_srcdir)/lib -Wl,--rpath -Wl,/opt/lampp/lib -L/opt/lampp/lib -I/opt/lampp/include -L/opt/lampp/lib -L/opt/lampp -rdynamic -L/opt/lampp/lib/ -L/opt/lampp/lib/"

/* Define to be the build LIBS.  */
#define PR_BUILD_LIBS " -lssl -lcrypto -L$(top_srcdir)/lib/libcap -lcap  -lssl -lcrypto  -lm -lmysqlclient -lz -lsupp -lcrypt -ldl  -pthread"
